const faqData = [
  {
    ...
    answer:
      "You can login using Single-Sign-On with Google. Add your Google credentials and register.",
  },
  {
  ...
  {
    question: "If I am a PM, how do I grant access to a user for a specific project?",
    answer:
